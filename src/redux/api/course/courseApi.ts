...
export const { useGetAllCourseQuery,useGetSingleCourseByIdQuery,useEnrolledCourseMutation,useGetEnrolledCoursesQuery,useGetIsEnrolledCourseQuery,useGetAllCourseByTeacherQuery} = courseApi