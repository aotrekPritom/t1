'use client'
import { useCreateStudentMutation, useLoginStudentMutation } from "@/redux/api/auth/authApi";
...
const  RegisterPage: React.FC = () => {
    ...
    return (
     <div className="container mx-auto flex justify-center items-center  w-full min-h-screen">
            ...
            <p className="text-center text-sm">Already have an account ? <Link href='/login' className="text-blue-500">Plase login</Link></p>
        </div>
     </div>
    );
};
